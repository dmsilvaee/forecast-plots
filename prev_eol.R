...
ini_day <- 20190519
ini_day2 <- 20190519
#data para nomear os graficos - tentar automatizar
day_name <- "19-05-2019"
#Limites do eixo Y
limy_sup <- 7000
limy_inf <- 500
...
#Concatenando o nome da pasta principal com os dados da geracao eolica
...
#Concatenando o nome dos arquivos com a previsao de geracao
...
#Subplot
par(mfrow=c(3,3))
plot(yd0~x,type="l",xlab = "t(h)",ylab = "Geracao (MW)", main=as.Date(day_name,"%d-%m-%Y"), ylim=range(limy_inf:limy_sup))
plot(yd1~x,type="l",xlab = "t(h)",ylab = "Geracao (MW)", main=as.Date(day_name,"%d-%m-%Y")+1, ylim=range(limy_inf:limy_sup))
plot(yd2~x,type="l",xlab = "t(h)",ylab = "Geracao (MW)", main=as.Date(day_name,"%d-%m-%Y")+2, ylim=range(limy_inf:limy_sup))
plot(yd3~x,type="l",xlab = "t(h)",ylab = "Geracao (MW)", main=as.Date(day_name,"%d-%m-%Y")+3, ylim=range(limy_inf:limy_sup))
plot(yd4~x,type="l",xlab = "t(h)",ylab = "Geracao (MW)", main=as.Date(day_name,"%d-%m-%Y")+4, ylim=range(limy_inf:limy_sup))
plot(yd5~x,type="l",xlab = "t(h)",ylab = "Geracao (MW)", main=as.Date(day_name,"%d-%m-%Y")+5, ylim=range(limy_inf:limy_sup))
plot(yd6~x,type="l",xlab = "t(h)",ylab = "Geracao (MW)", main=as.Date(day_name,"%d-%m-%Y")+6, ylim=range(limy_inf:limy_sup))
plot(yd7~x,type="l",xlab = "t(h)",ylab = "Geracao (MW)", main=as.Date(day_name,"%d-%m-%Y")+7, ylim=range(limy_inf:limy_sup))
plot(yd8~x,type="l",xlab = "t(h)",ylab = "Geracao (MW)", main=as.Date(day_name,"%d-%m-%Y")+8, ylim=range(limy_inf:limy_sup))
#plot(yd9~x,xlab = "t(h)",ylab = "Geracao (MW)", sub = "D9")
